  ...
  return (
    <main className="min-h-screen bg-[#f7f5f0] text-[#111111]">
      ...
      <section className="relative min-h-screen overflow-hidden pt-20">
        <div className="relative mx-auto h-[calc(100vh-160px)] min-h-[560px] w-full max-w-[1500px] overflow-hidden bg-[#f7f5f0]">
          <Image
        ...
        <footer className="absolute inset-x-0 bottom-0 z-10 border-t border-black/10 bg-[#f7f5f0]/94 backdrop-blur-xl">
          <div className="mx-auto flex h-20 max-w-[1500px] items-center justify-between px-9 text-[10px] uppercase tracking-[0.42em] text-black/58">
