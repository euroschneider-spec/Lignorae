...
export const metadata: Metadata = {
  title: "FORMA — Skulpturale schwarze Füllfederhalter",
  description:
    "FORMA ist die skulpturale schwarze Sprache von LIGNORAE: gebrannte Oberflächen, reduzierte Silhouetten und ruhige Schreibobjekte aus München.",
  alternates: {
    canonical: "/de/collections/forma",
    languages: {
  ...
  openGraph: {
    title: "FORMA — Skulpturale schwarze Füllfederhalter von LIGNORAE",
    description:
      "Gebrannte Oberflächen, reduzierte Silhouetten und ruhige Schreibobjekte, handgefertigt in München.",
    url: "/de/collections/forma",
    type: "website",
    images: [
      {
        url: "/og-image.jpg",
        width: 1200,
        height: 630,
        alt: "FORMA skulpturaler schwarzer Füllfederhalter von LIGNORAE",
      },
    ],
  },
  twitter: {
...
export default async function GermanFormaPage() {
      ...
      <section className="mx-auto w-full max-w-[1500px] px-9 pb-24 pt-40">
        ...
        <div className="grid gap-14 md:grid-cols-[0.9fr_1.1fr] md:items-end">
          ...
          <p className="max-w-2xl text-base font-normal leading-8 text-black/95 md:text-lg">
            FORMA ist die prägende Sprache von LIGNORAE: geschwärzte
            Oberflächen, reduzierte Silhouetten und Schreibobjekte mit ruhiger,
            fast skulpturaler Präsenz.
          </p>
        </div>
        ...
        <div className="group mx-auto mt-24 max-w-[1200px] overflow-hidden bg-[#eeeae2]">
          <Image
            ...
            alt="LIGNORAE FORMA Kollektion in einem weißen Galerieraum"
            width={1500}
            height={1000}
            priority
        ...
        <div className="mx-auto grid max-w-[1500px] gap-12 md:grid-cols-3">
          <article className="border-l border-black/20 pl-7">
            ...
            <p className="text-sm font-normal leading-7 text-black/95">
              Gebrannte Oberflächen bringen Tiefe, Textur und eine kontrollierte
              schwarze Präsenz ohne unnötige Ornamentik.
            </p>
          </article>
          ...
          <article className="border-l border-black/20 pl-7">
            ...
            <p className="text-sm font-normal leading-7 text-black/95">
              Die Kollektion folgt einfachen Linien, klaren Proportionen und
              einer Silhouette, die mehr als skulpturales Objekt denn als
              Accessoire funktioniert.
            </p>
          </article>
          ...
          <article className="border-l border-black/20 pl-7">
            ...
            <p className="text-sm font-normal leading-7 text-black/95">
              Die Präsentationsform wird Teil des Objekts: Schutz, Ritual und
              visueller Rahmen für das Schreibinstrument.
            </p>
          </article>
        </div>
      </section>
      ...
      <section className="mx-auto w-full max-w-[1500px] flex-1 px-9 py-28">
        <div className="mb-14 flex flex-col gap-4 md:flex-row md:items-end md:justify-between">
          ...
          <p className="max-w-xl text-base font-normal leading-8 text-black/95">
            Jedes FORMA Objekt kann eine eigene Archivseite mit Materialnotizen,
        ...
        {pieces.length === 0 ? (
          <div className="border border-black/15 bg-[#fbfaf7] p-10 text-center">
            <p className="text-base font-normal leading-7 text-black/95">
              Es wurde noch kein FORMA Objekt zum Archiv hinzugefügt.
            </p>
          </div>
        ) : (
