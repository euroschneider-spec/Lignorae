...
export async function generateMetadata({
  ...
  if (!post || !post.published) {
    return {
      title: "Journalbeitrag nicht gefunden",
      robots: {
        index: false,
        follow: false,
      },
  ...
  const canonical = `/de/journal/${post.slug}`;
...
export default async function GermanJournalPostPage({
  params,
}: {
  params: Promise<{ slug: string }>;
}) {
