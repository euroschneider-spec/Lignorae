...
export default function OriginNo3Page() {
  return (
    <main className="min-h-screen bg-[#1a130d] text-[#f5f1e8]">
      ...
      <section className="relative flex min-h-screen items-center overflow-hidden border-b border-[#4a3522]/70 px-6 pt-28">
        <div className="absolute inset-0 bg-[url('/origin-no-3.jpg')] bg-cover bg-center opacity-30" />
        ...
        <div className="relative z-10 mx-auto grid max-w-7xl items-center gap-16 md:grid-cols-[0.9fr_1.1fr]">
          <div>
            ...
            <p className="mb-10 max-w-xl text-lg leading-relaxed text-[#d6d1c7] md:text-xl">
              A darker, more contemplative ORIGIN study, defined by polished
              depth, golden reflections, and the quiet tension between shadow
              and grain.
            </p>
          ...
          <div className="hidden md:block">
            <div className="group overflow-hidden rounded-[2rem] border border-[#c6a66a]/35 bg-[#21170f]/80 shadow-2xl transition duration-500 hover:border-[#c6a66a]/70 hover:shadow-[0_0_35px_rgba(198,166,106,0.18)]">
              <div className="aspect-[4/5] bg-[url('/origin-no-3.jpg')] bg-cover bg-center transition duration-700 group-hover:scale-105" />
            </div>
          </div>
        </div>
      </section>
      ...
      <FadeIn>
        <section className="mx-auto grid max-w-7xl gap-10 px-6 py-28 md:grid-cols-[1fr_1fr]">
          <div className="group overflow-hidden rounded-3xl border border-[#c6a66a]/30 bg-[#21170f] transition duration-500 hover:-translate-y-1 hover:border-[#c6a66a]/70 hover:shadow-[0_0_30px_rgba(198,166,106,0.14)]">
            <div className="aspect-[4/3] bg-[url('/origin-no-3.jpg')] bg-cover bg-center transition duration-700 group-hover:scale-105" />
          </div>

          <div className="group overflow-hidden rounded-3xl border border-[#c6a66a]/30 bg-[#21170f] transition duration-500 hover:-translate-y-1 hover:border-[#c6a66a]/70 hover:shadow-[0_0_30px_rgba(198,166,106,0.14)]">
            <div className="aspect-[4/3] bg-[url('/origin-no-3-detail.jpg')] bg-cover bg-center transition duration-700 group-hover:scale-105" />
          </div>
        </section>
      </FadeIn>
        ...
        <section className="mx-auto grid max-w-7xl gap-16 px-6 pb-28 md:grid-cols-[0.9fr_1.1fr]">
          <div>
            ...
            <h2 className="mb-8 text-4xl font-light md:text-5xl">
              A study in shadow, polish, and restraint.
            </h2>
          </div>

          <div className="space-y-6 text-lg leading-relaxed text-[#d0cabf]">
            <p>
              ORIGIN No. 3 brings a quieter, more dramatic character into the
              early LIGNORAE archive. Its visual strength comes less from
              ornament and more from contrast, depth, and controlled reflection.
            </p>

            <p>
              The darker material presence gives the instrument a more reserved
              authority. Gold-toned details catch the light sparingly, allowing
              the surface and silhouette to remain calm and deliberate.
            </p>

            <p>
              Within the ORIGIN series, this piece marks a step toward a more
              cinematic language: still tactile, still personal, but with a
              stronger sense of atmosphere and permanence.
            </p>
          </div>
        </section>
      </FadeIn>
          ...
          <div className="mx-auto max-w-7xl">
            ...
            <div className="grid gap-6 md:grid-cols-4">
              ...
              <div className="rounded-3xl border border-[#4a3522]/70 bg-[#21170f] p-6">
                ...
                <p className="text-xl font-light">Dark figured hardwood</p>
              </div>
