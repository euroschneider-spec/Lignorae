...
export default function OriginNo01Page() {
  return (
    <main className="min-h-screen bg-[#1a130d] text-[#f5f1e8]">
      ...
      <section className="relative flex min-h-screen items-center overflow-hidden border-b border-[#4a3522]/70 px-6 pt-28">
        <div className="absolute inset-0 bg-[url('/origin-no-01.jpg')] bg-cover bg-center opacity-30" />
        ...
        <div className="relative z-10 mx-auto grid max-w-7xl items-center gap-16 md:grid-cols-[0.9fr_1.1fr]">
          <div>
            ...
            <div className="flex flex-wrap gap-3 text-xs uppercase tracking-[0.22em] text-[#c6a66a]">
              <span className="rounded-full border border-[#c6a66a]/50 px-4 py-2">
                ORIGIN
              </span>
              <span className="rounded-full border border-[#c6a66a]/50 px-4 py-2">
                Archive Piece
