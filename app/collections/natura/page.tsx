    ...
    <main className="min-h-screen bg-[#f7f5f0] text-[#111111]">
      ...
      <section className="mx-auto max-w-[1500px] px-9 pb-24 pt-40">
        <div className="grid gap-14 md:grid-cols-[0.9fr_1.1fr] md:items-end">
          <div>
            <p className="mb-8 text-[11px] uppercase tracking-[0.48em] text-[#555555]">
          ...
          <p className="max-w-2xl text-base font-light leading-8 text-[#2f2f2f] md:text-lg">
      ...
      <section className="border-y border-[#d8d2c8] bg-[#fbfaf7] px-9 py-24">
        <div className="mx-auto grid max-w-[1500px] gap-12 md:grid-cols-3">
          <article className="border-l border-[#c9c2b7] pl-7">
            <p className="mb-6 text-[10px] uppercase tracking-[0.42em] text-[#555555]">
              01
            </p>
            <h2 className="mb-5 text-3xl font-light tracking-[-0.04em]">
              Honesty
            </h2>
            <p className="text-sm font-light leading-7 text-[#2f2f2f]">
      ...
      <section className="mx-auto max-w-[1500px] px-9 py-28">
        <div className="mb-14 flex flex-col gap-4 md:flex-row md:items-end md:justify-between">
          <div>
            <p className="mb-4 text-[11px] uppercase tracking-[0.48em] text-[#555555]">
              Available objects
            </p>
          ...
          <p className="max-w-xl text-base font-light leading-8 text-[#2f2f2f]">
        ...
        {pieces.length === 0 ? (
          <div className="border border-[#d8d2c8] bg-[#fbfaf7] p-10 text-center">
            <p className="text-base font-light leading-7 text-[#2f2f2f]">
          ...
          <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
            {pieces.map((piece) => (
              <Link
                ...
                className="group overflow-hidden border border-[#d8d2c8] bg-[#fbfaf7] transition duration-500 hover:-translate-y-1 hover:border-[#9f9688]"
              >
                ...
                <div className="p-8">
                  ...
                  <p className="mb-7 text-sm font-light leading-7 text-[#2f2f2f]">
                    {piece.shortDescription}
                  </p>
                  <p className="text-[10px] uppercase tracking-[0.35em] text-[#2f2f2f] transition group-hover:text-black">
                    View object →
                  </p>
                </div>
              </Link>
