    ...
    <main className="flex min-h-screen flex-col bg-[#1a130d] text-[#f5f1e8]">
      ...
      <section className="mx-auto max-w-6xl flex-1 px-6 py-40">
        ...
        <p className="mb-16 max-w-4xl text-xl leading-relaxed text-[#d0cabf]">
          Instruments shaped from reclaimed wood connected to sacred spaces,
          historical buildings, restorations, and architectural memory.
        </p>
        ...
        <div className="group overflow-hidden rounded-3xl border border-[#4a3522]/70 transition duration-500 hover:-translate-y-1 hover:border-[#c6a66a]/60">
          <div className="aspect-[16/8] bg-[url('/sacra.jpg')] bg-cover bg-center transition duration-700 group-hover:scale-105" />
        </div>
        ...
        <div className="mt-16 grid gap-8 md:grid-cols-2">
          <div className="rounded-3xl border border-[#4a3522]/70 bg-[#21170f] p-8">
            ...
            <p className="leading-relaxed text-[#d0cabf]">
              SACRA is built around reclaimed wood with documented origin,
              historical dignity, and a visible connection to places shaped by
              time, devotion, restoration, and human presence.
            </p>
          </div>
          ...
          <div className="rounded-3xl border border-[#4a3522]/70 bg-[#21170f] p-8">
            ...
            <p className="leading-relaxed text-[#d0cabf]">
              Each piece is intended to preserve a fragment of history in a
              functional writing instrument: not as a relic, but as a quiet,
              respectful continuation.
            </p>
          </div>
        </div>
        ...
        <section className="mt-24 border-t border-[#4a3522]/70 pt-20">
          <div className="mb-14 flex flex-col gap-4 md:flex-row md:items-end md:justify-between">
            ...
            <p className="max-w-xl text-lg leading-relaxed text-[#cfc8bc]">
              Each instrument in the SACRA collection receives its own archive
              page, with photographs, material notes, specifications, and
              availability.
            </p>
          </div>

          {sacraPieces.length === 0 ? (
            <div className="rounded-3xl border border-[#4a3522]/70 bg-[#21170f] p-10 text-center">
              <p className="text-lg leading-relaxed text-[#d0cabf]">
                No SACRA pieces have been added to the archive yet.
              </p>
            </div>
          ) : (
            <div className="grid gap-10 md:grid-cols-2">
              {sacraPieces.map((piece) => (
                <Link
                  key={piece.id}
